...
const TerminadosProcesos = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Obtener la suma de metas de los terminados
    ...
    return (
        <>
            <Link className="link" to={'/procesos-horas#terminados'}>
                <div className="procesos-2">
                    <div className="procesos-2__flex">
                        <p className="procesos-2__p-azul">B. Terminado</p>
                        <div className="procesos__campo-terminados">
...
export default TerminadosProcesos;