...
const GeneradoHora = () => {
    ...
    return (
        <>
            <div className="generado-hora" id="generadores">
                <table className="tabla">
                    ...
                    <tbody>
                        <tr className="tabla__tr">
                            <Link to={'/generadores-horas'} className="link__tabla">
                                <div className="tabla__th-flex">
                                    <img src="./img/ver.png" alt="imagen-ver" className="tabla__ver" />
                                    <td className="tabla__td position">Generado <br/> <span className="tabla__td-span">Meta: <span className="tabla__span-meta">{meta}</span></span></td>
                                </div>
                            </Link>
