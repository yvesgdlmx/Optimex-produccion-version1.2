...
const PulidoHora = () => {
    ...
    useEffect(() => {
        const obtenerMeta = async () => {
            const { data } = await clienteAxios(`/metas/metas-pulidos`);
    ...
    useEffect(() => {
        const obtenerRegistros = async () => {
            const { data } = await clienteAxios(`/pulido/pulido/actualdia`);
    ...
    return (
        <>
            <div className="generado-hora" id="pulidos">
                <table className="tabla">
                    ...
                    <tbody>
                        <tr className="tabla__tr">
                            <Link to={'/pulidoras-horas'} className="link__tabla">
                                <div className="tabla__th-flex">
                                    <img src="./img/ver.png" alt="imagen-ver" className="tabla__ver" />
                                    <td className="tabla__td position">Pulido <br/> <span className="tabla__td-span">Meta: <span className="tabla__span-meta">{meta}</span></span></td>
                                </div>
                            </Link>
