...
const JobCompleteHora = () => {
    ...
    useEffect(() => {
        const obtenerMeta = async () => {
            ...
            const metasLensLog = data.registros.filter(registro => registro.name.includes('JOB COMPLETE'));
    ...
    useEffect(() => {
        const obtenerRegistros = async () => {
            ...
            const registrosLensLog = data.registros.filter(registro => registro.name.includes('JOB COMPLETE'));
                        ...
                        <tr className="tabla__tr">
                            <Link to={'/jobcomplete-horas'} className="link__tabla">
                                <div className="tabla__th-flex">
                                    ...
                                    <td className="tabla__td position">Job-Complete <br/> <span className="tabla__td-span">Meta: <span className="tabla__span-meta">{meta}</span></span></td>
                                </div>
                            </Link>
