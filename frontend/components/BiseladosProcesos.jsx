...
const BiseladosProcesos = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Obtener la suma de metas de los biselados
    ...
    return (
        <>
            <Link className="link" to={'/procesos-horas#biselados'}>
                <div className="procesos-2">
                    <div className="procesos-2__flex">
                        <p className="procesos-2__p-azul">Biselado</p>
                        <div className="procesos__campo-biselados">
...
export default BiseladosProcesos;