...
const EngraversProcesos = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Obtener la suma de metas de los engravers
    ...
    return (
        <>
            <Link className="link" to={'/procesos-horas#engravers'}>
                <div className="procesos-2">
                    <div className="procesos-2__flex">
                        <p className="procesos-2__p-azul">Engraver</p>
                        <div className="procesos__campo-engravers">
...
export default EngraversProcesos;