       ...
       <table className="b-tabla__table">
          <thead className="b-tabla__thead">
            <tr className="b-tabla__tr-head">
              <th className="b-tabla__th-head text-align-left bg-color" colSpan="15"><p className="position-rela">Bloqueo de tallado</p></th>
            </tr>
            <tr className="b-tabla__tr-head">
        ...
        <table className="b-tabla__table mt-2">
          <thead className="b-tabla__thead">
            <tr className="b-tabla__tr-head">
              <th className="b-tabla__th-head text-align-left bg-color" colSpan="15"><p className="position-rela">Generadores</p></th>
            </tr>
            <tr className="b-tabla__tr-head">
              <th className="b-tabla__th-head">Nombre</th>
              <th className="b-tabla__th-head">Total Acumulado</th>
...
export default TablerosTallado