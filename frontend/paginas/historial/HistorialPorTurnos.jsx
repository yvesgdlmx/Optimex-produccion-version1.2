...
const HistorialPorTurnos = () => {
  ...
  const [hitsPorTurno, setHitsPorTurno] = useState({ matutino: 0, vespertino: 0, nocturno: 0 });
            ...
            <tbody className="a-tabla__tbody">
              {registrosEstacion.map((registro, index) => (
                <tr className="a-tabla__tr-body" key={index}>
                  <td className="a-tabla__td-body">{maquinas[index]}</td>
  ...
  return (
    <>
      ...
      <div className='selectores'>
        ...
        <div className='selectores__campo'>
          <label className='selectores__label' htmlFor="">Dia</label>
